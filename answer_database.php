...
<?php 
  ...
  if(mysqli_num_rows($check) == 1){
    $update = mysqli_query($conn,"UPDATE student_answer SET answer='$ans' WHERE s_id='$s_id' AND exam_id='$exam_id' AND q_id='$q_id'");

    echo "<script>window.open('give_exam.php','_self')</script>";
  }
  $query = "INSERT INTO student_answer(s_id, exam_id, q_id, answer) VALUES ('$s_id', '$exam_id', '$q_id', '$ans')";
