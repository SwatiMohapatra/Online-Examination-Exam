...
$tid= $_SESSION['t_id'];
        ...
        $query = "INSERT INTO exam_detail(examid, title, teacher, subject, totalmarks, time, date) VALUES (NULL, '$title', '$tid', '$sub', '$total', 'current_timestamp()', current_timestamp());";

mysqli_query($conn, $query);


$query = "select examid from exam_detail where teacher='$tid' order by date,time desc limit 1";
